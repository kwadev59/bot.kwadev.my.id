...
<div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between mb-4 gap-3">
    ...
    <div class="text-lg-end d-flex flex-column flex-sm-row gap-2 align-items-sm-center justify-content-sm-end">
        ...
        <div class="d-flex flex-column flex-sm-row gap-2">
            ...
            <a
                href="<?= BASE_URL; ?>/TuMonitoringController/exportCsv?tanggal=<?= htmlspecialchars($selectedDate); ?>"
